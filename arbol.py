...
def inordenAlturaMenorQue(arbol, altura):
    if (arbol is not None):
        inordenAlturaMenorQue(arbol['izq'], altura)
        if (arbol['datos']['altura'] < altura):
            print(arbol['info'])
        inordenAlturaMenorQue(arbol['der'], altura)


def inordenPesoMayorQue(arbol, peso):
    if (arbol is not None):
        inordenPesoMayorQue(arbol['izq'], peso)
        if (arbol['datos']['peso'] > peso):
            print(arbol['info'])
        inordenPesoMayorQue(arbol['der'], peso)
